...
In this example, I actually already used one such argument, `seed=3`, which should result in a warning message about divergent transitions.

```{r fit_example_1_1_display, eval = FALSE}
fit1 <- sociality_model(standat = sdat1, refresh = 0, parallel_chains = 4, seed = 1)
```

```{r fit_example_1_1, cache=TRUE, include=FALSE}
