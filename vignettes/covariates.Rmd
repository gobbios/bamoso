...
In the framework of simple network metrics (I'm thinking of SRI or HWI or DSI) this is just not possible and we rely on ad-hoc solutions with potentially severe shortcomings (for some background see @hart2022): SRI, DSI and friends are non-parametric indices and therefore can't be incorporated in generative simulations.
